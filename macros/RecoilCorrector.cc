...
void RecoilCorrector::ComputeU(float genpt, 
  ...
  if (anotherUni == 0) {
    ...
    u1       = mu + anotherUni/fabs(anotherUni) * laSigma * TMath::ErfInverse(fabs(anotherUni)) * TMath::Sqrt(2);
    u1ScUp   = u1 - muSig;   // Recoil is negative, so subtract for higher MET
    u1ScDown = u1 + muSig;
    u1ResUp   = mu + anotherUni/fabs(anotherUni) * (laSigma + laSigmaSig) * TMath::ErfInverse(fabs(anotherUni)) * TMath::Sqrt(2);
    u1ResDown = mu + anotherUni/fabs(anotherUni) * (laSigma - laSigmaSig) * TMath::ErfInverse(fabs(anotherUni)) * TMath::Sqrt(2);
  ...
  if (anotherUni == 0) {
    ...
    u2       = mu + anotherUni/fabs(anotherUni) * laSigma * TMath::ErfInverse(fabs(anotherUni)) * TMath::Sqrt(2);
    u2ResUp   = mu + anotherUni/fabs(anotherUni) * (laSigma + laSigmaSig) * TMath::ErfInverse(fabs(anotherUni)) * TMath::Sqrt(2);
    u2ResDown = mu + anotherUni/fabs(anotherUni) * (laSigma - laSigmaSig) * TMath::ErfInverse(fabs(anotherUni)) * TMath::Sqrt(2);
